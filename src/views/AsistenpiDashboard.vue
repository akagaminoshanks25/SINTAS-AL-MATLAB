<template>
  <v-container fluid class="py-8">
    <v-row>
      <v-col cols="12">
        <h2 class="text-h5 font-weight-bold mb-4">Dashboard Asisten Ustadzah</h2>
      ...
      <v-col cols="12" md="4">
        <v-card elevation="2" class="pa-4">
          ...
          <p class="text-h6 font-weight-bold">6</p>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" md="4">
        <v-card elevation="2" class="pa-4">
          ...
          <p class="text-h6 font-weight-bold">4</p>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" md="4">
        <v-card elevation="2" class="pa-4">
          ...
          <p class="text-h6 font-weight-bold">10</p>
        </v-card>
      </v-col>
    </v-row>
  </v-container>
